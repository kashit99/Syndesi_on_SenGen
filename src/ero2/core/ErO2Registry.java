...
public final class ErO2Registry {
  ...
  public void updateService(String serviceLocator,String luminance, String temperature, String humidity, String timestamp, String actuation){
    ...
    ero2ser.setActuation_state(actuation);

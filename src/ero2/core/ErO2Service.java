...
public class ErO2Service {
  ...
  private String actuation_state;
  ...
  public String getActuation_state() {
	return actuation_state;
}
  
  public void setActuation_state(String actuation_state) {
	this.actuation_state = actuation_state;
}
